...
public class MatrixCalc {
    ...
    private static void testQuaternionf() {
        Matrix4f ani1 = loadMatrix("1 0 0 0 0 -0.06466547 -0.997907 0 0 0.997907 -0.06466556 3.810999 0 0 0 1");
        Quaternionf qani1 = new Quaternionf();
        qani1.setFromNormalized(ani1);
        // assimp (0,684 0,730 0,000 0,000)
        // this (-0,730 0,000 0,000 0,684)
        System.out.println(qani1.toString(new DecimalFormat("0.000")));
