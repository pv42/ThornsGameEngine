...
public class GUIText {
	 ...
	 *            - the font that this text should use.
	 * @param position3D
	 * 			  - point in world space text is bound to
	 * @param position
	 *            - the position on the screen where the top left corner of the
	 *            text should be rendered. The top left corner of the screen is
	 *            (0, 0) and the bottom right is (1, 1).
	 ...
	 *            - whether the text should be centered or not.
	 */
	public GUIText(String text, float fontSize, FontType font, Vector3f position3D, Vector2f position, float maxLineLength,
				   boolean centered) {
		this.textString = text;
		this.fontSize = fontSize;
		this.font = font;
	 ...
	 *
	 * @param color
	 *            - color to set (3d-Vector between (0,0,0) and (1,1,1))
	 */
	...
	public boolean isUsePosition3D() {
		return usePosition3D;
	}
}
