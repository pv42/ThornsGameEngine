...
public class Blaster extends Gun {
    ...
    public Blaster() {
        ...
        soundBuffer = AudioMaster.loadSound("Blaster");
    ...
    public boolean shot( Player player) {
        ...
        //todo new Particle(new ParticleTexture(Loader.loadTexture("boom"),5,true,false), Vector3f.add(player.getEyePosition(),getMuzzlePosition(),null), Maths.scaleVector(new Vector3f(1,0,0),getProjectileSpeed()),0,10f,0,2);
