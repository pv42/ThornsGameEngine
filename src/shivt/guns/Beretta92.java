...
public class Beretta92 extends Gun{
    ...
    public boolean shot(Player player) {
        ...
        new Particle(new ParticleTexture(Loader.loadTexture("boom.png"),5,true,false), Vector3f.add(player.getEyePosition(),getMuzzlePosition(),null), Maths.scaleVector(new Vector3f(1,0,0),getProjectileSpeed()),0,10f,0,2);
